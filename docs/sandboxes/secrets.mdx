...
Secret changes through modify are Rust-SDK and CLI only for now. See [Update a running sandbox](/sandboxes/lifecycle#update-a-running-sandbox) for how changes are applied.
